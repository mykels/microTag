package micro.tag.domain.model.language;

import micro.tag.domain.model.enums.ParsableEnum;
import micro.tag.domain.model.stream.StreamDecorator;

import java.util.Optional;

public enum Language implements ParsableEnum {
	ab("Abkhaz", "аҧсуа"),
	aa("Afar", "Afaraf"),
	...
	Language(String tongue, String nativeTongue) {
		this.tongue = tongue;
		this.nativeTongue = nativeTongue;
	}

	public static Optional<Language> parse(String name) {
		return StreamDecorator.of(values()).findEqualIgnoreCase(name, ParsableEnum::getName);
	}

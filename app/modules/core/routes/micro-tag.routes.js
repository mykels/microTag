...
function routesConfig($routeProvider) {
	$routeProvider
		.when('/terminal', {
			templateUrl: 'app/modules/core/views/terminal/terminal.html',
			controller: 'TerminalController'
		})
		.when('/settings', {
			templateUrl: 'app/modules/core/views/settings/settings.html',
			controller: 'SettingsController'
		})
		.when('/logs', {
			templateUrl: 'app/modules/core/views/log/logs.html',

...
// TODO: eliminate this shit when possible

angular.module('microTag').controller('AlertDemoCtrl', ["$scope", function ($scope) {
    $scope.alerts = [{
        type: 'danger',
...
angular.module('microTag').controller('ModalInstanceCtrl', ["$scope", "$uibModalInstance", "items", function ($scope, $uibModalInstance, items) {
